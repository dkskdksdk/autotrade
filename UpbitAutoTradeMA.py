...
access = "i3kkcOWCWQxAZAKfPeUMZIQRUDxtjxCIPGxbJ4jA"
secret = "LxVUxXmGv9xwKT1KNunlnh8VRrmuPEFLGQOM4HQz"
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            ma25 = get_ma25("KRW-XRP")
            current_price = get_current_price("KRW-XRP")
            if target_price < current_price and ma25 < current_price:
                krw = get_balance("KRW")
                if krw > 5000:
